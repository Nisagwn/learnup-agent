...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      // Supabase Auth ile kullanıcıyı oluştur. Profil satırı (profiles),
      // auth.users trigger'ı (handle_new_user) ile metadata'dan otomatik oluşur.
      await signUp({
        email,
        password,
        role,
        // Sadece öğrenciyse sınıf bilgisini gönder
        ...(role === 'student' && {
          grade,
